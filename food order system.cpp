...
void one::menu1()
{
    ...
    cout<<"\n\n\n\t===========================\t\t\t==========================\t\t\t\t==========================="<<endl;
    cout<<"\t[1] Veggie Supreme (Tk.480)\t\t\t[2] Exotica Pizza(Tk.440)\t\t\t\t[3] Chicken Sizzler (Tk.580)\n\t[4] Chrispy Chicken (TK.520)\t\t\t[5] Spaghetti (Tk.350)\t\t\t\t\t[6] Country Feast (Tk.400)\n\t[7] Tetrazzini (Tk.420)\t\t\t\t[8] Double Cheese (Tk.540)\t\t\t\t[9] Makizushi (Tk.548)\n\t[10] Ham Burger (Tk.390)\t\t\t[11] Margherita Pizza(Tk.525)\t\t\t\t[12] Fish 'n' Chips (Tk.425)\n\t[13] Fajitas (Tk.335)\t\t\t\t[14] Tempura (Tk.324)\t\t\t\t\t[15] Hot Dog (Tk.360)\n\t===========================\t\t\t==============================\t\t\t\t===========================\n\n\n\t\t\t\t\t\t\t\t[16] DELETE"<<endl;
    cout<<"\n\t======================================================================================================================================="<<endl;
}
class two:public one//Inheritance,encapsulation(in one class variable and function are declare)
{
protected:
...
public:
    ...
    {
        ofstream write;
        write.open("E:\\io\\purba.txt");
        if(!write)//error handeling(If its taken worng input file are not open ,,,,)
        {
...
c:
        ...
        cout << endl;
        cout << endl;
        cout << "\t\t\t\t\t\t\t  Cashier :  Team Eleven"<<endl;
        cout << endl;
        cout<<"\t\t\t\t\t\t\t\t    YOUR TOTAL BILL IS Tk."<<s<<endl;
        write<<"\t\t\t\t\t\t\t ";
